...
def get_generations(model, dataloader, number_of_generations):
    ...
    with torch.no_grad():
        ...
        for batch in tqdm.tqdm(dataloader):
            ...
            generations = torch.ones((number_of_generations, input_length + max_length_of_generated_sequence), dtype=torch.long, device=device)
            ...
            for i in range(generations.shape[0]):
                ...
                for answer in reference_answers:
                    ...
                    for rouge_type in rouge_types:
                        sequence_dict[rouge_type + '_to_target'] = max(rouge_results[rouge_type].mid.fmeasure, sequence_dict[rouge_type + '_to_target'])
